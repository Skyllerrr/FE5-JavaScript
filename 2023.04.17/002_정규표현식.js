...
'paullab CEO hansanghun hello CEO'
// 문자열 1개만 매칭되어 변경
'paullab CEO hansanghun hello CEO'.replace('CEO', 'CTO')
// flag로 global을 주어서 전체 변경 (m-다중라인, i-대소문자구분x)
'paullab CEO hansanghun hello CEO'.replace(/CEO/g, 'CTO')
// 패턴을 찾아 Array로 반환
'paullab CEO hansanghun hello CEO'.match(/CEO/g)
// 패턴으로 split
'paullab CEO hansanghun hello CEO'.split(/CEO/g)
...
['a10', 'a20', 'a30'].map(v => parseInt(v.slice(1))).reduce((a, b) => a + b, 0)




// replace 매우 고급 문법 보강 설명 //
const string = `sanghun, han
gildong, hong
hojung, choi
junho, lee`
